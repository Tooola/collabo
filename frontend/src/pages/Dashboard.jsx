                          ...
                          <div key={member.id} className="flex items-center justify-between py-4 group">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400 mt-0.5">{member.role === 'admin' ? 'Admin' : (member.teams?.find(t => t.teamId === team.id)?.role || 'dev')}</p>
                              </div>
                            </div>
